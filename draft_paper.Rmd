...
In order to explore the hypothesis that the recent stallin in life expectancy, most marked in England and Wales, was an expected 'correction' after a decade of unusually fast life expectancy improvements, we have selected the years from 1980 onwards.
 

```{r, echo=FALSE}
# load packages

pacman::p_load(here, tidyverse, flextable) # using flextable instead of gt. It seems to be better 
...
The following figures show life expectancy at birth and at age 65 for selected nations from 1980 to the latest available year.
...
Next, we compare the annual change in life expectancy at birth and at aged 65 years for the 6 nations from 1980 to the latest available year, by sex.
