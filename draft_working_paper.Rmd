...
**Reviewer request: Calculation by AICc**

In the manuscript itself, BIC is used twice: 

- To select the best performing 1 and 2 breakpoint model
- To select, for each population, whether the 0, 1 or 2 breakpoint model is preferable. 

At both of these stages, the AICc criterion could be used instead. This has already been implemented using the `AICcmodavg::AICc` package and function. 



```{r}
best_breakpoint_model_predictions_aicc <- 
  segmented_breakpoints_models %>% 
...
**Reviewer 1 Request: Can the residuals of the models be presented?**
...
The following shows the same but separated by starting age
...
The follow shows differences by sex
