...
- Netherlands (`NLD`) - last minute addition from Danny
...
And a simplified version to save 
...
hmd_ex_selected_countries_with_synth %>% 
  ...
  labs(
    ...
    title = "Life expectancies at birth for selected nations",
    subtitle = "1980 to 2020 or latest available year",
    caption = "Source: Human Mortality Database.\nSynthetic Germany is an 80%/20% weighted average of West Germany and East Germany respectively",
    colour = "Sex", linetype = "Sex"
  ) + 
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))

ggsave("figures/proposed/e0_trend.png", height = 20, width = 20, units = "cm", dpi = 300)
ggsave("figures/proposed/e0_trend.tiff", height = 20, width = 20, units = "cm", dpi = 300)
...
I'm going to make this the first proposed figure
...
hmd_ex_selected_countries_with_synth %>% 
  ...
  labs(
    x = "Year",
    y = "Life Expectancy at age 65 (years)",
    title = "Life expectancies at age 65 for selected nations",
    subtitle = "1980 to 2020 or latest available year",
    caption = "Source: Human Mortality Database.\nSynthetic Germany is an 80%/20% weighted average of West Germany and East Germany respectively",
    colour = "Sex", linetype = "Sex"
...
ggsave("figures/proposed/e65_trend.png", height = 20, width = 20, units = "cm", dpi = 300)
ggsave("figures/proposed/e65_trend.tiff", height = 20, width = 20, units = "cm", dpi = 300)
```
...
I now want a simplified and slightly better looking version of this for the main manuscript 
...
ggsave("figures/proposed/che0_smoother.png", height = 15, width = 25, units = "cm", dpi = 300)
ggsave("figures/proposed/che0_smoother.tiff", height = 15, width = 25, units = "cm", dpi = 300)


```


And now the same but at age 65 
...
ggsave("figures/proposed/che65_smoother.png", height = 15, width = 25, units = "cm", dpi = 300)
ggsave("figures/proposed/che65_smoother.tiff", height = 15, width = 25, units = "cm", dpi = 300)
...
ggsave("figures/proposed/average_improvement1980-2020.png", height = 20, width = 30, units = "cm", dpi = 300)
ggsave("figures/proposed/average_improvement1980-2020.tiff", height = 20, width = 30, units = "cm", dpi = 300)
...
ggsave("figures/proposed/reduced_average_improvement1980-2020.png", height = 20, width = 25, units = "cm", dpi = 300)
ggsave("figures/proposed/reduced_average_improvement1980-2020.tiff", height = 20, width = 25, units = "cm", dpi = 300)
...
The following combinations of country, starting age, and sex indicate statistically significant improvements in model fit if using a model which allows the annual changes to vary by decade
...
all_null_decadal_models %>% 
  ...
  pivot_wider(values_from = label, names_from = x) %>% 
  kable(format = "html", table.attr = "style=\"color: black;\"",caption = "Coefficients of decadal differences, Netherlands, males, by starting age (0 = life expectancy at birth; 65 = life expectancy at age 65 years") %>% 
  kableExtra::kable_styling() %>% 
  footnote(general = "The baseline is the average annual rate of improvement in the 1980s. The other terms indicate increments or decrements from this baseline. Statistical significance of coefficients: * if p < 0.10, ** if p < 0.05, *** if p < 0.01"
  )
```

So, for the Netherlands, males, e65, the 2000s were a period of exceptionally rapid improvement. 
...
I'm going to just get the predicted values for the best model
...
First I want to show the values against predicted 
...
ggsave("figures/proposed/e0_breakpoint.png", height = 15, width = 25, units = "cm", dpi = 300)
ggsave("figures/proposed/e0_breakpoint.tiff", height = 15, width = 25, units = "cm", dpi = 300)
...
ggsave("figures/proposed/e65_breakpoint.png", height = 15, width = 25, units = "cm", dpi = 300)
ggsave("figures/proposed/e65_breakpoint.tiff", height = 15, width = 25, units = "cm", dpi = 300)
```


## Differences in annual mortality

The following shows what the best-performing models suggest are the differences in annual mortality from year to year
...
best_breakpoint_model_predictions %>% 
  ...
  mutate(
    ch_ex      = 9 (ex - lag(ex)                 ), 
    ch_ex_pred = 52.25 * (prediction - lag(prediction) )
  ) %>% 
  filter(!is.na(ch_ex), !is.na(ch_ex_pred))  %>% 
  ggplot(aes(year)) + 
  geom_point(aes(y = ch_ex), alpha = 0.35) +
  facet_grid(sex ~ country) +
  geom_hline(yintercept = 0) + 
  geom_line(aes(y = ch_ex_pred), colour = "red") +
  theme(
    axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)
  ) + 
  scale_y_continuous(breaks = seq(-30, 50, by = 10)) +
...
ggsave("figures/proposed/ch_e0_breakpoint.png", height = 15, width = 25, units = "cm", dpi = 300)
ggsave("figures/proposed/ch_e0_breakpoint.tiff", height = 15, width = 25, units = "cm", dpi = 300)

```
And finally for age 65
...
ggsave("figures/proposed/ch_e65_breakpoint.png", height = 15, width = 25, units = "cm", dpi = 300)
ggsave("figures/proposed/ch_e65_breakpoint.tiff", height = 15, width = 25, units = "cm", dpi = 300)
```
