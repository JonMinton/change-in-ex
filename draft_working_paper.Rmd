...
tmp <- compare_best_breakmodel_with_null %>% 
  mutate(
...
<<<<<<< HEAD:draft_paper.Rmd
Next, let's look closer at France, Scotland, and E&Ws life expectancy at birth for males.

Jon: can we somehow include these 3 in the below to produce a graph? I tried adding into the first chunk but it does not run the later parts.
=======
>>>>>>> b2406ae4ff6fa0544a9ee9f000b45ce103736d57:draft_working_paper.Rmd
