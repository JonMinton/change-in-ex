...
render_country_report <- function(code, country){
  rmarkdown::render(
    here("param_reports", "markdown_template.rmd"), # this is where the markdown document to use as a template is located
    output_dir = here("param_reports", "outputs"), # This is the output directory  
